...
tern<-ggplot(data = miles_tern, aes(x = GD_p, y = GT_p, z = HL_p, 
...
gridExtra::arrangeGrob(tern, tern, tern, layout_matrix = rbind(c(1,1,2),
                                        c(1,1,3)))
...
# ga <- grid.arrange(pt, pc, widths = c(2,1.3))
