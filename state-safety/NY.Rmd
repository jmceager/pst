...
#setting plot items
capt = "Source: PHMSA Incident and Mileage Data (2010-2023)"
...
df %>%
  ...
  labs(title = paste(moStateL, "Pipeline Incident Rate"),
       subtitle = "All Systems, All Incidents per 1,000 Miles (2010-2022)",
       caption = capt,
       tag = tag,
       y = "Incident Rate", 
       x = NULL)
...
df %>%
  ...
  labs(title = paste(moStateL, "Significant Incident Rate"),
       subtitle = "All Systems, Significant Incidents per 1,000 Miles (2010-2022)",
       caption = capt,
       tag = tag,
