...
cause_dict = c(
  `Material/Weld/Equip Failure` = "Materiales, soldadura, y equipo",
  `All Other Causes`    = "Otros",
  `Corrosion`    =  "Corrosión",
  `Incorrect Operation`    = "Error por parte del operador", 
...
hl_hca_dash +
  scale_color_manual(values = pst1, labels = c("SÍ", "NO"))+
  scale_fill_manual(values = pst1, labels = c("SÍ", "NO"))+  
