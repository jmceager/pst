...
ggplot()+
  ...
  labs(title = "2022 Website Transparency Performance",
       fill = "Rating:",
       caption = paste0("A fill of gray denotes states with no 2022 rating\n",capt),
       tag = tag)
...
ggsave("plots/everythingHorizontal.pdf", width = 3840, height = 2160, units = "px")
```
