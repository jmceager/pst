...
hl %>%
 ...
 #        shutdowndiff >= seconds(0)) %>%
  ...
  geom_histogram(fill = midBlue)+
  #geom_density(linewidth = 1, col = midBlue)+
  scale_x_continuous(trans = "pseudo_log",
                     name = NULL,
                     breaks = c(-7889400,-2629800,-604800,-86400,0, 
                                86400, 604800, 2629800, 31557600 ),
                     labels = c("-Year","-Month","-Week","-Day","0",  
                                "Day", "Week","Month", "Year"),
                     minor_breaks = c(-3944700,-1296000,-302400 ,-43200,
                                      43200, 302400, 1296000, 15778800))+
  scale_y_continuous(limits = c(-10,700), expand = c(0,0))+
  theme_pst()+
  theme(axis.line.x = element_blank())+
  labs(title = "Unfiltered Distribution of Shutdown Times")
```
