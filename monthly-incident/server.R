    ...
    leafletProxy("incMap", data = mapData()) %>%
      ...
      addCircleMarkers(radius = ~size, weight = 1, fillOpacity = 0.6,
                       ...
                       popup = paste0("<b>Operator:</b> ",
                                      ...
                                      mapData()$cleanLoc , 
                                      "<br>","<b>Impact:</b> ", 
                                      if_else(mapData()$IGNITE_IND == "YES", "Fire", ""),
                                      if_else(mapData()$IGNITE_IND == "YES" &
                                                mapData()$EXPLODE_IND == "YES",
                                              " & ", ""),
                                      if_else(mapData()$IGNITE_IND == "NO" &
                                                mapData()$EXPLODE_IND == "NO",
                                              "No Fire or Explosion", ""),
                                      if_else(mapData()$EXPLODE_IND == "YES", "Explosion", ""), 
                                      "<br>",
                                      "<b>Release:</b> ",
